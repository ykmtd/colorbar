...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLOCK_100 }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { RST_IN }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
#set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { PS2_DAT }]; #IO_L10N_T1_AD15N_35 Sch=ps2_data
